...
import com.ryl.cms.domain.Category;
import com.ryl.cms.domain.Channel;
import com.ryl.cms.domain.Slide;
import com.ryl.cms.service.ArticleService;
import com.ryl.cms.service.SlideService;
...
public class HomeController {
	...
	public String Message(Model model,@RequestParam(value="cpage",defaultValue="1")Integer cpage){
		
		
		return "admin/tousu_message";
	}

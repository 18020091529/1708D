...
public class UserInfoServiceImpl implements UserInfoService {
	...
	public int reg(UserForm userForm) {
		...
		user.setGender(userForm.getGender()); // userForm中的性别就是user中的性别（com.ryl.cms.metas.Gender是枚举类型）
